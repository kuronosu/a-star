...
class Tile:
    ...
    def cost_g(self, other):
        ...
        return 10 if self.x == other.x or self.y == other.y else 14
    ...
    def __str__(self) -> str:
        return f"({self.x}, {self.y}, {'x' if self.is_obtacle else 'o'})"
